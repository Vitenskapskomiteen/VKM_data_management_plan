...
# Reshape2 is deprecated so might not work that long in to the future
# pivot_longer replaces it (but it requires a lot more arguments)
brei_data |> pivot_longer(-Navn, names_to = "variable", values_to = "value") |> kbl()
...
* Project_mame_yyyy.mm.dd
  * literature_data
<!-- If truely doing Systematic Review we need a "Protocol" section here too -->
    * Protocol
    * search_1
      * 1_search_query
      * 2_study_selection
...
oslo <-   geodata::elevation_30s(country="nor", mask=TRUE, path=here::here())
...
### Using setwd() / getwd() is discouraged (see https://www.tidyverse.org/blog/2017/12/workflow-vs-script/ )
### because it is rarely reproducible
### the library "here" is suggested as an alternative 
### Also RStudio Projects is an option  
### getwd() is replaced by here::here below

#setwd("C:/Users/xx/prefered_folder")

# check if package is installed on users local system
